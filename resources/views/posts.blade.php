...
@section('container')
    ...
    @if($posts->count())
            ...
            <div class="card-body">
                ...
                <p>
                    <small class="text-muted">
                        Penulis: <a href="/posts?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> | Kategori: <a href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}</a>, {{ $posts[0]->created_at->diffForHumans() }}
                    </small>
                </p>
        ...
        {{-- <article class="mb-5 border-bottom pb-4">
            ...
            <p>Penulis: <a href="/authors/{{ $post->author->username }}" class="text-decoration-none">{{ $post->author->name }}</a> | Kategori: <a href="/categories/{{ $post->category->slug }}" class="text-decoration-none">{{ $post->category->name }}</a></p>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <p>
                            <small class="text-muted">
                                Penulis: <a href="/posts?author={{ $post->author->username }}" class="text-decoration-none">{{ $post->author->name }}</a>, {{ $post->created_at->diffForHumans() }}
                            </small>
                        </p>
