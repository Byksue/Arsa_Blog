...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <div class="container">
      <a class="navbar-brand" href="/">Arsa Muda Blog</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link @if($title == 'All Posts') active @endif" href="/posts">Blog</a>
          </li>
          <li class="nav-item">
            <a class="nav-link @if($title == 'All Categories') active @endif" href="/categories">Categories</a>
          </li>
        </ul>
